...
export default function AuthFlow() {
  ...
  const handleForgotPassword = () => setCurrentScreen("forgot")
  const handleRegister = () => setCurrentScreen("register")
  const handleRegisterSubmit = () => setCurrentScreen("login")
  const handleSendCode = (emailValue: string) => {
    setEmail(emailValue)
    setCurrentScreen("verify")
  }
  const handleVerify = () => setCurrentScreen("reset")
  const handleReset = () => setCurrentScreen("login")
